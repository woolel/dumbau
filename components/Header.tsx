      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-24">
          ...
          <div className="flex items-center gap-4">
            <Link
              to="/onion"
              className="hidden sm:block border border-gray-200 bg-gray-200 text-gray-700 rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-gray-300 focus:outline-none focus:shadow-outline"
            >
              장보기
            </Link>
            <button
          ...
          <div className="px-4 pt-2 pb-4 space-y-1">
            {NAV_LINKS.map((link) => (
             ...
             <Link
              to="/onion"
              onClick={() => setIsMenuOpen(false)}
              className="block w-full mt-4 text-center bg-teal-500 rounded-full px-6 py-3 text-sm font-medium text-white hover:bg-teal-600 transition-colors shadow"
            >
              바로 구매
            </Link>
          </div>
